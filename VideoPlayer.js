...
export default class VideoPlayer extends Component {
  ...
  renderTopControls() {
    ...
    const speedControl = this.props.disableSpeed
      ? this.renderNullControl()
      : this.renderDownload();
    const downloadControl = this.props.disableDownload
      ? this.renderNullControl()
  ...
  renderVolumeIcon() {
    return (
      <Image
        ...
        source={require('./assets/img/icon_sound.png')}
      />
    );
  }
